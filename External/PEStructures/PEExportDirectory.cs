...
namespace System.PEStructures
{
    public class PEExportDirectory : PEDataDirectory
    {
        ...
        public PEExport this[string exportName]
        {
            get
            {
                ...
                while (low <= high) // search for name using a quicksort (lunar magic)
                {
    ...
    public readonly struct ImageExportDirectory
    {
        ...
        [FieldOffset(0x14)]
        internal readonly int numExports;

        [FieldOffset(0x18)]
        internal readonly int numNames;

        [FieldOffset(0x1C)]
        internal readonly int lpExports;

        [FieldOffset(0x20)]
        internal readonly int lpNames;

        [FieldOffset(0x24)]
        internal readonly int lpNameOrdinals;
    }
